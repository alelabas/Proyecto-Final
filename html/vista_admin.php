...
<body>
    ...
    <article class="pag_principal">
        ...
        <section id="reservar-turno" class="servicios">
            <a href="http://localhost/Proyecto%20Final/php/vista_clientes_admin.php"> <h2>Clientes</h2> </a>
            <p>Visualiza y gestiona el perfil de un cliente.</p>
        </section>
        
        <section id="turnos-asignados" class="servicios">
            <a href="http://localhost/Proyecto%20Final/php/vista_concesionarios_admin.php"> <h2>Concesionarios</h2> </a>
